...
## Renamed workflow callbacks

| Canonical callback | Compatibility callback retained |
|---|---|
...
Toolbar bindings and characterization tests use the canonical names. The old
callbacks delegate directly to them so external bindings are not broken.
